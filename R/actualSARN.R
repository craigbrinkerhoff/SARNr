...
#' 
#' Joins DEM and RS river networks into a single vector product
#' 
...
#' 
#' @param networks: sarnnetwork object composed of coincident (variable type=1) and non-coincident (variable type=2) river networks
