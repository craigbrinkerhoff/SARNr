...
Classify water within your image. You can do this using bespoke methods or one the function included here (see below). Here we use NDWI-NDVI to force as much spectral contrast between land and water as possible following  https://doi.org/10.3390/s18082580.
...
```
If you are going to make your own river masks, simply make sure the output is a `terra::spatRaster` object with river pixels coded as 1s and land pixels as NaN.
